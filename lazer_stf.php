...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    /* Ürün tablosu (Toplam Genişlik ≈ 190mm olmalı) */
    ...
    table.items col:nth-child(3) { width: 50mm; }  /* Ürün Adı */
    table.items col:nth-child(4) { width: 25mm; }  /* Sac Türü */
    table.items col:nth-child(5) { width: 17mm; }  /* Kalınlık */
    table.items col:nth-child(6) { width: 18mm; }  /* Ağırlık */
    table.items col:nth-child(7) { width: 20mm; }  /* Kesim Türü */
    table.items col:nth-child(8) { width: 15mm; }  /* Süre */
    table.items col:nth-child(9) { width: 17mm; }  /* Maliyet */
    ...
    table.totals td { padding: 1mm 2mm; border: 0.3mm solid #000; }
...
<table class="head">
  <tr>
    ...
    <td class="titles">
      <div class="t1">STF (LAZER KESİM)</div>
      <div class="t2">SİPARİŞ TAKİP VE SEVK TEYİT FORMU</div>
    </td>
  </tr>
</table>

<div class="orderno">Sipariş Kodu: <?= h($o['order_code'] ?? '') ?> | Belge No: STF-<?= $id ?></div>
...
<table class="items">
  ...
  <tbody>
  <?php 
  $i=1; $total_cost=0.0; $total_weight=0.0; 
  foreach($items as $it): 
      $satirTop = (float)($it['calculated_cost'] ?? 0);
      $total_cost += $satirTop;
    ...
    <tr>
      ...
      <td style="text-align: center; vertical-align: middle; padding: 1mm;">
          <?php 
              ...
              if (!empty($showImage)): 
                  $imgSrc = $showImage;
                  // Yerel dosyayı bulup Base64'e çevirerek PDF'in resmi kesin görmesini sağlıyoruz.
          ...
          ?>
            <img src="<?= $imgSrc ?>" style="max-width:16mm; max-height:16mm; display:block; margin: 0 auto; object-fit:contain;">
          <?php else: ?>
            -
          <?php endif; ?>
      </td>
...
<table class="totals">
  ...
  <tr><td class="label">Genel Toplam</td><td class="value" style="color:#d32f2f; font-weight:bold; font-size:12px;"><?= $fmt($total_cost) ?> <?= h($currencySymbol) ?></td></tr>
</table>
