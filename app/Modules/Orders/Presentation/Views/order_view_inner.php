<?php
/**
 * order_view_inner.php — Sipariş görüntüleme içeriği
 * @var array  $o
 * @var array  $items
 * @var bool   $__is_admin_like
 * @var bool   $__is_musteri
 * @var bool   $__is_uretim
 * @var bool   $__show_stf
 * @var bool   $__show_ustf
 * @var bool   $__show_fiyat
 */
?>
<?php
    ...
    <div class="notebook-card">
        ...
        <div class="doc-header">
            ...
            <div class="doc-actions">
                <a class="doc-btn doc-btn-ghost" href="orders.php?a=edit&id=<?= (int)$o['id'] ?>">Düzenle</a>
                
                <?php if ($__show_stf): ?>
                    <a class="doc-btn doc-btn-orange" target="_blank" rel="noopener" href="orders.php?a=pdf&id=<?= (int)$o['id'] ?>">STF</a>
                <?php endif; ?>
                
                <?php if ($__show_ustf): ?>
                    <a class="doc-btn doc-btn-green" target="_blank" rel="noopener" href="orders.php?a=pdf_uretim&id=<?= (int)$o['id'] ?>">Üretim Föyü</a>
                <?php endif; ?>
